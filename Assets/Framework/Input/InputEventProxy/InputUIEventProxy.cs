...
public class InputUIEventProxy : IInputProxyBase
{
    ...
    public static InputButtonClickRegisterInfo GetOnClickListener(Button button, string UIName, string ComponentName,
        string parm, InputEventHandle<InputUIOnClickEvent> callback)
    {
        ...
        info.m_OnClick = () => { DispatchOnClickEvent(UIName, ComponentName, parm); };

        return info;
    }

    public static InputEventRegisterInfo<InputUILongPressEvent> GetLongPressListener(LongPressAcceptor acceptor,
        string UIName, string ComponentName, string parm, InputEventHandle<InputUILongPressEvent> callback)
    {
        ...
        info.m_OnLongPress = (type) => { DispatchLongPressEvent(UIName, ComponentName, parm, type); };

        return info;
    }

    internal static InputEventRegisterInfo<InputUIOnEndDragEvent> GetOnEndDragListener(string m_UIEventKey,
        string UIName, string ComponentName, InputEventHandle<InputUIOnEndDragEvent> callback)
    {
        InputEventRegisterInfo<InputUIOnEndDragEvent> info =
            HeapObjectPool<InputEventRegisterInfo<InputUIOnEndDragEvent>>.GetObject();
    ...
    internal static InputEventRegisterInfo<InputUIOnDragEvent> GetOnDragListener(string m_UIEventKey, string UIName,
        string ComponentName, InputEventHandle<InputUIOnDragEvent> callback)
    {
        InputEventRegisterInfo<InputUIOnDragEvent> info =
            HeapObjectPool<InputEventRegisterInfo<InputUIOnDragEvent>>.GetObject();
    ...
    internal static InputEventRegisterInfo<InputUIOnBeginDragEvent> GetOnBeginDragListener(string m_UIEventKey,
        string UIName, string ComponentName, InputEventHandle<InputUIOnBeginDragEvent> callback)
    {
        InputEventRegisterInfo<InputUIOnBeginDragEvent> info =
            HeapObjectPool<InputEventRegisterInfo<InputUIOnBeginDragEvent>>.GetObject();
    ...
    internal static InputEventRegisterInfo<InputUIOnMouseEvent> GetOnMouseListener(string m_UIEventKey, string UIName,
        string ComponentName, bool isDown, InputEventHandle<InputUIOnMouseEvent> callback)
    {
        InputEventRegisterInfo<InputUIOnMouseEvent> info =
            HeapObjectPool<InputEventRegisterInfo<InputUIOnMouseEvent>>.GetObject();
    ...
    public static InputEventRegisterInfo<InputUIOnScrollEvent> GetOnScrollListener(string UIName, string ComponentName,
        InputEventHandle<InputUIOnScrollEvent> callback)
    {
        InputEventRegisterInfo<InputUIOnScrollEvent> info =
            HeapObjectPool<InputEventRegisterInfo<InputUIOnScrollEvent>>.GetObject();
    ...
    public static InputEventRegisterInfo<InputUIOnDragEvent> GetOnDragListener(DragAcceptor acceptor, string UIName,
        string ComponentName, string parm, InputEventHandle<InputUIOnDragEvent> callback)
    {
        ...
        info.callBack = callback;
        info.m_acceptor = acceptor;
        info.m_OnDrag = (data) => { DispatchDragEvent(UIName, ComponentName, parm, data); };

        return info;
    }

    public static InputBeginDragRegisterInfo GetOnBeginDragListener(DragAcceptor acceptor, string UIName,
        string ComponentName, string parm, InputEventHandle<InputUIOnBeginDragEvent> callback)
    {
        ...
        info.callBack = callback;
        info.m_acceptor = acceptor;
        info.m_OnBeginDrag = (data) => { DispatchBeginDragEvent(UIName, ComponentName, parm, data); };

        return info;
    }

    public static InputEndDragRegisterInfo GetOnEndDragListener(DragAcceptor acceptor, string UIName,
        string ComponentName, string parm, InputEventHandle<InputUIOnEndDragEvent> callback)
    {
        ...
        info.callBack = callback;
        info.m_acceptor = acceptor;
        info.m_OnEndDrag = (data) => { DispatchEndDragEvent(UIName, ComponentName, parm, data); };
