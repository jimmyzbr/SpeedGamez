...
//#if !UNITY_WEBGL
        ...
        bool isLoadByPersistent =
            RecordManager.GetData(HotUpdateManager.c_HotUpdateRecordName).GetRecord(path, "null") == "null"
                ? false
                : true;
...
//#endif
    ...
    public static void LoadResourceConfig()
    {
        ...
        else
        {
            ...
            string r_path = null;
            if (RecordManager.GetData(HotUpdateManager.c_HotUpdateRecordName)
                    .GetRecord(c_ManifestFileName.ToLower(), "null") != "null")
            {
    ...
    public static void CreateResourcesConfig()
    {
        ...
        string path = PathTool.GetAbsolutePath(ResLoadLocation.Resource,
            c_ManifestFileName + "." + DataManager.c_expandName);
