...
public class AssetsPoolEditorWindow : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        switch (toolbarOption)
        {
            case 0:
                toolbarOption1 =
                    GUILayout.Toolbar(toolbarOption1, toolbarTexts1, GUILayout.Width(Screen.width * 3 / 4));
    ...
    private void DrawUnloadAssets()
    {
        ...
        EditorDrawGUIUtil.DrawScrollView(this, () =>
        {
            ...
            for (int i = 0; i < assetList.Count; i++)
            {
                ...
                EditorDrawGUIUtil.DrawFoldout(item,
                    "(" + item.useTimes + ")" + item.assetsName + "(" + item.GetFrequency() + ")",
    ...
    private void GameObjectPoolGUI()
    {
        EditorDrawGUIUtil.DrawScrollView(this, () =>
        {
            ...
            Dictionary<string, Dictionary<int, GameObject>> noCreate =
                new Dictionary<string, Dictionary<int, GameObject>>();
    ...
    {
        EditorDrawGUIUtil.DrawFoldout(assetsData,
            index + ".(" + assetsData.refCount + ")" + assetsData.assetName + "(" +
            GetSizeString(assetsData.GetObjectsMemorySize()) + "+" + GetSizeString(assetsData.GetBundleMemorySize()) +
            ")", () =>
            {
