...
public class AudioPlayerBase
{
    ...
    protected void PlayClip(AudioAsset au, string audioName, bool isLoop = true, float volumeScale = 1,
        float delay = 0f, float pitch = 1)
    {
    ...
    protected void PlayMusicControl(AudioAsset au, string audioName, bool isLoop = true, float volumeScale = 1,
        float delay = 0f, float fadeTime = 0.5f, string flag = "")
    {
        ...
        else
        {
            ...
            AddFade(au, VolumeFadeType.FadeOut2In, fadeTime, delay, flag, null,
                (value) => { PlayClip(value, audioName, isLoop, volumeScale, delay); });
        }
    }
