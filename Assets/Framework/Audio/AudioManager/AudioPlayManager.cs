...
public class AudioPlayManager : MonoBehaviour
{
    ...
    public static AudioAsset PlayMusic2D(string name, int channel, float volumeScale = 1, bool isLoop = true,
        float fadeTime = 0.5f, float delay = 0f, string flag = "")
    {
    ...
    public static void PlaySFX2D(string name, float volumeScale = 1f, float delay = 0f, float pitch = 1,
        string flag = "")
    {
