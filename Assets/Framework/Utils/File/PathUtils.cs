...
public class PathUtils
{
    ...
    /// <returns></returns>
    public static string CutPath(string fullPath, string cutFolderName, bool returnLatterPart = true,
        bool includeCutFolderName = false)
    {
...
//#endif
    ...
    public static string[] GetDirectoryFileNames(string path, string[] endsWith, bool isNeedExtension = false,
        bool isIncludeChildFolder = true)
    {
