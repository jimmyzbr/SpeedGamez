    ...
    public static class SimpleJsonTool
    {
        ...
        public static IJsonSerializerStrategy CurrentJsonSerializerStrategy
        {
            get
            {
                ...
                {
                    arg_18_0 = (SimpleJsonTool._currentJsonSerializerStrategy =
                        SimpleJsonTool.PocoJsonSerializerStrategy);
                }

                return arg_18_0;
            }
            set { SimpleJsonTool._currentJsonSerializerStrategy = value; }
        }
        ...
        public static object DeserializeObject(string json, Type type, IJsonSerializerStrategy jsonSerializerStrategy)
        {
            ...
            return (type != null && (obj == null || !ReflectionsUtils.IsAssignableFrom(obj.GetType(), type)))
                ? (jsonSerializerStrategy ?? SimpleJsonTool.CurrentJsonSerializerStrategy).DeserializeObject(obj, type)
                : obj;
        }
                            ...
                            else
                            {
                                ...
                                if (num >= 6)
                                {
                                    ...
                                    if (new string(json, index, 2) == "\\u" && uint.TryParse(
                                            ...
                                            CultureInfo.InvariantCulture, out num3))
                                    {
        ...
        private static object ParseNumber(char[] json, ref int index, ref bool success)
        {
            ...
            if (text.IndexOf(".", StringComparison.OrdinalIgnoreCase) != -1 ||
                text.IndexOf("e", StringComparison.OrdinalIgnoreCase) != -1)
            {
                double num;
            ...
            StringBuilder builder)
        {
            ...
            else
            {
                ...
                if (dictionary != null)
                {
                    flag = SimpleJsonTool.SerializeObject(jsonSerializerStrategy, dictionary.Keys, dictionary.Values,
                        builder);
                }
                else
                {
