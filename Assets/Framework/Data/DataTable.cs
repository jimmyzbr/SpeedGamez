...
public class DataTable : Dictionary<string, SingleData>
{
    ...
    public static DataTable Analysis(string stringData)
    {
        ...
        {
            throw new Exception("DataTable Analysis Error: 错误位置：" + debugContent + " 行:" + debugLineCount / 2 + " 列：" +
                                debugRowCount + " key:->" + debugKey + "<- PropertyName：->" + debugProperty + "<-\n" +
                                e.ToString()); // throw  
        }
    }
    ...
    public static void AnalysisFieldType(DataTable l_data, string[] l_lineData)
    {
        ...
        for (int i = 1; i < l_lineData.Length && i < l_data.TableKeys.Count; i++)
        {
            if (!l_lineData[i].Equals(""))
            {
                ...
                {
                    l_data.m_fieldAssetTypes.Add(field,
                        (DataFieldAssetType)Enum.Parse(typeof(DataFieldAssetType), tempType[1]));
                }
                else
                {
...
public class SingleData : Dictionary<string, string>
{
    ...
    public int GetInt(string key)
    {
        ...
        {
            throw new Exception("SingleData GetInt Error TableName is :->" + data.m_tableName + "<- key : ->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- content: ->" + content + "<- \n" +
                                e.ToString());
        }

        throw new Exception("Don't Exist Value or DefaultValue TableName is :->" + data.m_tableName + "<- key : ->" +
                            key + "<-  singleDataName : ->" + m_SingleDataKey + "<-"); // throw  
    }
    ...
    public int[] GetIntArray(string key)
    {
        ...
        {
            throw new Exception("SingleData GetIntArray Error TableName is :->" + data.m_tableName + "<- key : ->" +
                                key + "<-  singleDataName : ->" + m_SingleDataKey + "<- content: ->" + content +
                                "<- \n" + e.ToString());
        }
    ...
    public float GetFloat(string key)
    {
        ...
        {
            throw new Exception("SingleData GetFloat Error TableName is :->" + data.m_tableName + "<- key :->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }

        throw new Exception("Don't Exist Value or DefaultValue by ->" + key + "<- TableName is : ->" +
                            data.m_tableName + "<- singleDataName : ->" + m_SingleDataKey + "<-"); // throw  
    }
    ...
    public float[] GetFloatArray(string key)
    {
        ...
        {
            throw new Exception("SingleData GetFloatArray Error TableName is :->" + data.m_tableName + "<- key :->" +
                                key + "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public bool GetBool(string key)
    {
        ...
        {
            throw new Exception("SingleData GetBool Error TableName is :->" + data.m_tableName + "<- key->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- content: ->" + content + "<- \n" +
                                e.ToString());
        }
    ...
    public bool[] GetBoolArray(string key)
    {
        ...
        {
            throw new Exception("SingleData GetBoolArray Error TableName is :->" + data.m_tableName + "<- key :->" +
                                key + "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public string GetString(string key)
    {
        ...
        {
            throw new Exception("SingleData GetString Error TableName is :->" + data.m_tableName + "<- key->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public Vector2 GetVector2(string key)
    {
        ...
        {
            throw new Exception("SingleData GetVector2 Error TableName is :->" + data.m_tableName + "<- key->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public Vector3[] GetVector3Array(string key)
    {
        ...
        {
            throw new Exception("SingleData GetVector3Array Error TableName is :->" + data.m_tableName + "<- key->" +
                                key + "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public Vector3 GetVector3(string key)
    {
        ...
        {
            throw new Exception("SingleData GetVector3 Error TableName is :->" + data.m_tableName + "<- key->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public Color GetColor(string key)
    {
        ...
        {
            throw new Exception("SingleData GetColor Error TableName is :->" + data.m_tableName + "<- key->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public T GetEnum<T>(string key) where T : struct
    {
        ...
        {
            throw new Exception("SingleData GetEnum Error TableName is :->" + data.m_tableName + "<- key->" + key +
                                "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public string[] GetStringArray(string key)
    {
        ...
        {
            throw new Exception("SingleData GetStringArray Error TableName is :->" + data.m_tableName + "<- key->" +
                                key + "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
    ...
    public Array GetArray(string key)
    {
        try
        {
            ...
            {
                return ParseTool.String2Array(data.GetFieldType(key), data.m_defaultValue[key],
                    data.GetArraySplitFormat(key));
            }
        }
        catch (Exception e)
        {
            throw new Exception("SingleData GetStringArray2 Error TableName is :->" + data.m_tableName + "<- key->" +
                                key + "<-  singleDataName : ->" + m_SingleDataKey + "<- \n" + e.ToString());
        }
