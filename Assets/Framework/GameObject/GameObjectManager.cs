...
public class GameObjectManager
{
    ...
    private static Dictionary<string, Dictionary<int, GameObject>> createPools =
        new Dictionary<string, Dictionary<int, GameObject>>();

    private static Dictionary<string, Dictionary<int, GameObject>> recyclePools =
        new Dictionary<string, Dictionary<int, GameObject>>();
    ...
    public static GameObject CreateGameObjectByPool(GameObject prefab, GameObject parent = null,
    ...
    private static GameObject GetNewObject(bool isAlwaysNew, string objName, GameObject prefab,
        GameObject parent = null, bool isSetActive = true)
    {
        GameObject go = null;
        string name = objName;
