...
public class UIManager : MonoBehaviour
{
    ...
    static public Dictionary<string, List<UIWindowBase>>
    ...
    public static void CloseUIWindow(string UIname, bool isPlayAnim = true, UICallBack callback = null,
        params object[] objs)
    {
    ...
    public static void CloseUIWindow<T>(bool isPlayAnim = true, UICallBack callback = null, params object[] objs)
    ...
    {
        ResourceManager.LoadAsync(UIName, (resObject) => { OpenUIWindow(UIName, callback, objs); });
    }
