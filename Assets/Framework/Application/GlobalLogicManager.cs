...
{
    //全局逻辑
    static Dictionary<string, IApplicationGlobalLogic> s_GlobalStatus =
        new Dictionary<string, IApplicationGlobalLogic>();
    ...
    public static void InitLogic(string logicName)
    {
        ...
        {
            IApplicationGlobalLogic l_statusTmp =
                (IApplicationGlobalLogic)Activator.CreateInstance(Type.GetType(logicName));
