...
public class GameBootConfig
{
    ...
    [ShowGUIName("后台运行模式")] public bool runInBackground = true;

    [NoShowInEditor] public Dictionary<string, ClassValue> allAppModuleSetting = new Dictionary<string, ClassValue>();
