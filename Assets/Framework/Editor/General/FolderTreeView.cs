...
public class FolderTreeView : TreeView
{
    ...
    public override void OnGUI(Rect rect)
    {
        ...
        else
        {
            ...
            searchRect = new Rect(rect.x + rect.width / 2, rect.y + 3, rect.width / 2,
    ...
    protected override void RowGUI(RowGUIArgs args)
    {
        ...
        if (e.type == EventType.MouseDown && args.rowRect.Contains(e.mousePosition) && e.clickCount == 2 &&
            dblclickItemCallBack != null)
        {
...
public class FolderTreeViewItem : TreeViewItem
{
    ...
    public FolderTreeViewItem(int id, int depth, string displayName, string fullPath, bool isDirectory) : base(id,
        depth, displayName)
    {
        m_fullPath = fullPath;
