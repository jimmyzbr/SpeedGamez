...
public class UnityInternalIconWindow : EditorWindow
{
    ...
    private string[] toolbarTextsSec =
    {
        "传递给 EditorGUIUtility.FindTexture 的参数", "IconContent获取的", "传递给 EditorGUIUtility.LoadIcon 的参数",
        "添加EditorWindowTitleAttribute 特性的窗口的图标"
    };
    ...
    void OnGUI()
    {
        ...
        switch (toolbarOption)
        {
            case 0:
                ...
                toolbarOptionSec =
                    GUILayout.Toolbar(toolbarOptionSec, toolbarTextsSec, GUILayout.Width(Screen.width - 40));
                GUILayout.FlexibleSpace();
    ...
    {
        string tt = ResourceIOTool.ReadStringByFile(Application.dataPath + "/Script/Core/Editor/res/EditorWindow/" +
                                                    fileName + ".txt");
