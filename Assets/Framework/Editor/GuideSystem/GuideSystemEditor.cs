...
public class GuideSystemEditor
{
    ...
    {
        string path = Application.dataPath + "/Resources/" + DataManager.c_directoryName + "/" +
                      GuideSystemBase.c_guideDataName + "." + DataManager.c_expandName;
    ...
    static void CreateGuideWindowScript()
    {
        ...
        string SavePath = Application.dataPath + "/Script/UI/" + GuideSystemBase.c_guideWindowName + "/" +
                          GuideSystemBase.c_guideWindowName + ".cs";
