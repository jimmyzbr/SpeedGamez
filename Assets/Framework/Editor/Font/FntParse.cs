    ...
    public class FntParse
    {
            ...
            for (int i = keys.Length - 1; i >= 0; i--)
            {
                switch (keys[i])
                {
                    ...
                    case "y":
                        ...
                        break;
                    case "width":
                        w = int.Parse(values[i]);
                        break;
                    case "height":
                        h = int.Parse(values[i]);
                        break;
                    case "xoffset":
                        xo = int.Parse(values[i]);
                        break;
                    case "yoffset":
                        yo = int.Parse(values[i]);
                        break;
                    case "xadvance":
                        xadvance = int.Parse(values[i]);
                        break;
                }
            }
        ...
        private bool ReadTextKerning(int idx, ref string line, ref List<CharacterInfo> list)
        {
            ...
            for (int i = keys.Length - 1; i >= 0; i--)
            {
                ...
                {
                    case "first":
                        kerning.first = int.Parse(values[i]);
                        break;
                    case "second":
                        kerning.second = int.Parse(values[i]);
                        break;
                    case "amount":
                        kerning.amount = int.Parse(values[i]);
                        break;
                }
            }
