...
public class EditorDrawGUIUtil
{
    ...
    public static object DrawBaseValue(GUIContent content, object data)
    {
        ...
        content.text = richTextSupport
            ? GetFormatName(content.text, type, "green", data)
            : GetFormatName(content.text, type, "", data);
        ...
        if (CanEdit)
        {
            ...
            else if (type == typeof(string))
            {
                ...
                GUILayout.EndHorizontal();
                     ...
                     type.BaseType == typeof(UnityEngine.Object) || type.BaseType == typeof(Component) ||
            ...
            {
                DrawFoldout(data, content, () => { obj = DrawList("", data, null, null); });
            }
            else if (type.Name == typeof(Dictionary<,>).Name)
            {
                DrawFoldout(data, content, () => { obj = DrawDictionary("", data); });
            }
            ...
            {
                DrawFoldout(data, content, () => { obj = DrawClassData("", type.FullName, data); });
            }
        }
        else
        {
    ...
    public static object DrawClassData(string name, object data, List<string> hideFieldPropertyNames = null,
        CallBack<MemberInfo> callAffterDrawField = null, CallBack callEndClassDraw = null)
    {
    ...
    /// <returns></returns>
    public static object DrawClassData(GUIContent name, object data, List<string> hideFieldPropertyNames = null,
        CallBack<MemberInfo> callAffterDrawField = null, CallBack callEndClassDraw = null)
    {
        if (data == null)
        {
    ...
    /// <returns></returns>
    public static T DrawPopup<T>(string name, T selectedStr, List<T> displayedOptions,
        CallBack<T> selectChangeCallBack = null, CallBackR<string, T> customShowItemTextCallBack = null)
    {
    ...
    public static object DrawList(string name, object data, CallBackR<object> addCustomData = null,
        CallBack<bool, object> ItemChnageCallBack = null, CallBackR<object, object> customDrawItem = null,
        CallBackR<string, object> itemTitleName = null)
    {
    ...
    /// <returns></returns>
    public static object DrawList(GUIContent name, object data, CallBackR<object> addCustomData = null,
        CallBack<bool, object> ItemChnageCallBack = null, CallBackR<object, object> customDrawItem = null,
        CallBackR<string, object> itemTitleName = null)
    {
        if (data == null)
    ...
    /// <param name="customDrawItem">自定义绘制Item</param>
    /// <returns></returns>
    public static int DrawPage(GUIContent name, int index, object data, CallBackR<object> addCustomData = null,
        CallBack<bool, object> ItemChnageCallBack = null, CallBackR<object, object> customDrawItem = null)
    {
        if (data == null)
        {
    ...
    public static object DrawArray(string name, object data, CallBackR<object> addCustomData = null,
        CallBack<bool, object> ItemChnageCallBack = null, CallBackR<object, object> customDrawItem = null)
    {
    ...
    /// <param name="customDrawItem">自定义绘制Item</param>
    /// <returns></returns>
    public static object DrawArray(GUIContent name, object data, CallBackR<object> addCustomData = null,
        CallBack<bool, object> ItemChnageCallBack = null, CallBackR<object, object> customDrawItem = null)
    {
        if (data == null)
        {
    ...
    public static string DrawSearchFieldSelect(string name, string selectStr, string[] displayedOptions,
        CallBack<string> selectCallback)
    {
    ...
    /// <returns></returns>
    public static string DrawSearchFieldSelect(GUIContent name, string selectStr, string[] displayedOptions,
        CallBack<string> selectCallback)
    {
        string res = "";
