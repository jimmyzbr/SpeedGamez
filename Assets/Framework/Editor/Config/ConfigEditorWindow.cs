...
public class ConfigEditorWindow : EditorWindow
{
    ...
    void DeleteConfigGUI()
    {
        if (m_currentConfigName != "None")
        {
            if (GUILayout.Button("删除配置"))
            {
                ...
                {
                    File.Delete(Application.dataPath + "/Resources/" + ConfigManager.c_directoryName + "/" +
                                m_currentConfigName + ".json");
    ...
    public static Dictionary<string, object> GetEditorConfigData(string ConfigName)
    {
        ...
        string dataJson = ResourceIOTool.ReadStringByFile(PathTool.GetEditorPath(ConfigManager.c_directoryName,
            ConfigName, ConfigManager.c_expandName));
    ...
    public static void SaveEditorConfigData(string ConfigName, Dictionary<string, object> data)
    {
        ...
        EditorUtil.WriteStringByFile(
            PathTool.GetEditorPath(ConfigManager.c_directoryName, ConfigName, ConfigManager.c_expandName),
            configDataJson);
