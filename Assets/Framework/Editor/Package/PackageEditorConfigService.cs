...
public class PackageEditorConfigService
{
    ...
    public static void SavePackageEditorConfig()
    {
        ...
        editorConfig.Add(BundleConfigEditorWindow.c_keyRelyPackages,
            JsonTool.List2Json<EditPackageConfig>(relyPackages)); //依赖包
        editorConfig.Add(BundleConfigEditorWindow.c_keyBundles,
