...
class ProjectBuildService : Editor
{
    ...
    {
        get { return Application.version + "." + VersionService.LargeVersion + "." + VersionService.SmallVersion; }
    }
    ...
    static void SetApplicationMode(AppMode mode)
    {
        ...
        switch (mode)
        {
            case AppMode.Developing:
                appModeDefine = "APPMODE_DEV";
                break;
            case AppMode.QA:
                appModeDefine = "APPMODE_QA";
                break;
            case AppMode.Release:
                appModeDefine = "APPMODE_REL";
                break;
        }
...
#else
        return Application.productName + "_" + Version + "_" + ChannelName + "_" + GetModeName(ApplicationMode) + "_" +
               GetTimeString();
#endif
    }
    ...
    static string GetTimeString()
    {
        ...
        return date.Year + string.Format("{0:d2}", date.Month) + string.Format("{0:d2}", date.Day) + "_" +
